    ...
    >
      <div style={{ maxWidth: "1150px", margin: "0 auto" }}>
        ...
        <p style={{ color: "#94a3b8", maxWidth: "680px", lineHeight: "28px" }}>
          Web and mobile are connected to the same bus route, ETA, login, and crowd prediction APIs.
        </p>
        ...
        >
          ...
          <Stat label="Average ETA" value={`${dashboard?.averageEtaMinutes || 0} min`} />
        </div>
          ...
          {routes.map((route) => (
            ...
            >
              <div style={{ display: "flex", justifyContent: "space-between", gap: "12px" }}>
                ...
                <span style={{ color: "#5eead4", fontWeight: 700 }}>{route.crowd}</span>
              </div>
              <p style={{ color: "#94a3b8", marginTop: "8px", lineHeight: "22px" }}>
